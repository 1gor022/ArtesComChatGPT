      ...
      <section className="hero dark-section" id="inicio">
        ...
        <div className="container hero-grid">
          ...
          <div className="hero-demo">
            ...
            <div className="hero-comparison"><div><span>ANTES</span><ProductImage src="/example/taca-antes.jpg" alt="Foto original de uma taça de vidro segurada com a mão" /></div><div className="versus">→</div><div><span>DEPOIS</span><ProductImage src="/example/taca-depois.png" alt="Arte profissional criada para divulgar a taça de vidro" fit="contain" /></div></div>
      ...
      <section className="gallery section-light">
        <div className="container">
          ...
          <div className="comparison-grid" ref={carouselRef} onScroll={updateSlide}>
            <Comparison before="/example/hamburguer-antes.jpg" after="/example/hamburguer-stories-depois.webp" channel="Stories" title="Hambúrguer" />
            <Comparison before="/example/cadeira-antes.webp" after="/example/cadeira-catalogo-depois.png" channel="Catálogo WhatsApp" title="Cadeira de madeira" />
            <Comparison before="/example/hidratante-antes.jpg" after="/example/hidratante-feed-depois.png" channel="Feed" title="Hidratante natural" />
          </div>
